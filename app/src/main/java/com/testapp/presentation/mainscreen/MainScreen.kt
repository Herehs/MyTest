...
fun MainScreen(vm: TestViewModel = viewModel()) {
    ...
    val size by rememberSaveable { mutableFloatStateOf(quiz.questions.size.toFloat()) }
    ...
    CenterAlignedTopAppBar(
        ...
        actions = {
            ...
            IconButton(onClick = {if (count < size) { vm.increaseCount() }}) {}
        },
    ...
    Button(
        ...
        enabled = count.toFloat() == (count / size)
    ) {
